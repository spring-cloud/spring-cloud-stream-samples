...
Spring Cloud Stream producers provided using native decoding to use the Confluent avro serializer and similarly the consumer using native decoding to use the Confluent Avro deserializer.
...
If your use case requires you to use these external tools, then we recommend using the stratgies implemented in these samples.
